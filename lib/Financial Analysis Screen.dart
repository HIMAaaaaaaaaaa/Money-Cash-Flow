...
class FinancialAnalysisScreen extends StatefulWidget {
  @override
  _FinancialAnalysisScreenState createState() => _FinancialAnalysisScreenState();
}
...
class _FinancialAnalysisScreenState extends State<FinancialAnalysisScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    final incomeDoc = await FirebaseFirestore.instance.collection('finance').doc('monthly_income').get();
    if (incomeDoc.exists) {
      setState(() {
    ...
    List<double> monthlyData = List.filled(12, 0.0); // 12 months for monthly analysis
                ...
                BarChartData(
                  ...
                  barGroups: List.generate(7, (index) {
                    return BarChartGroupData(
                      x: index,
                      barRods: [
                        BarChartRodData(toY: _weeklyExpenses[index], color: Colors.blue),
                      ],
                    );
                  }),
                ),
                ...
                LineChartData(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      ...
                      isCurved: true,
                      color: Colors.red, // بدلًا من colors: [Colors.red]
                      barWidth: 4,
